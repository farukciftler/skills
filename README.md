...
| | |
|---|---|
| **Kütüphane girdisi** | 172 (145 benzersiz ad + 27 ayrışmış sürüm) |
| **Kategori** | 15 |
| **Toplam SKILL.md** | ~1,8 MB · 780 ek dosya |
| **Script içeren** | 57 skill |
| **Referans dosyası olan** | 98 skill |
| **Kaynak dağılımı** | 71 kurulu · 53 proje-içi · 75 claude.ai · 6 yalnız GitHub |

## Nereden başlamalı

| İhtiyaç | Dosya |
|---|---|
| Bir skill'i isimden aramak | **[INDEX.md](INDEX.md)** — 172 girdilik alfabetik tablo |
