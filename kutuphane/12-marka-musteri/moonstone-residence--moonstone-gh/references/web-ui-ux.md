...
alınmış; site **yayında** (WordPress, özel tema `moonstone-residence`, nginx,
NS: `domaincontrol.com`). Aşağıdaki mimari hem mevcut yapıyı tarif eder hem
hedefi: doğru kurulursa
