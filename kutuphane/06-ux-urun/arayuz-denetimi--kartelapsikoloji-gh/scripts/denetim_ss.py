...
ROLLER = {
    "danisman": {
        ...
        "rotalar": ["/bugun", "/takvim", "/danisanlarim", "/hakedisim", "/bildirimler"],
    },
    "sekreter": {
        "eposta": "sekreter@demo.local",
        "rotalar": ["/pano", "/tahsilat", "/danisanlar", "/talepler", "/senkron"],
    },
    "yonetici": {
        "eposta": "yonetici@demo.local",
        "rotalar": ["/kokpit", "/hakedis", "/doluluk", "/ayarlar", "/denetim"],
    },
}
