...
## 🔎 3. WEB ARAMA STRATEJİLERİ VE SORGULARI

Yeni aday araştırması yaparken şu sorgu kalıpları kullanılır:

```text
# Şam & Çarşı Lezzetleri (Alkolsüz)
"Damascus" traditional sweets "Hamidiyah" OR "Midan" "Bakdash" OR "Halawet" -alcohol -bar

# Halep & Hama Tarihi Mekanlar
"Hama" OR "Bosra" OR "Tartus" historical sites UNESCO monuments -hotel -resort

# Suriye Manastır ve Antik Kentleri
"Maaloula" OR "Saydnaya" OR "Apamea" OR "Saint Simeon" Syria heritage history

# Geleneksel Zanaat ve Kahvehaneler
"Damascus" OR "Aleppo" historic cafe "Hakawati" OR "Caravanserai" OR "Khan"
```
...
```bash
# Site dosyalarıyla backlog'u senkronize et ve Excel CSV dosyasını güncelle:
node backlog/scripts/sync-inventory.mjs

# Belirli bir şehir için yeni aday araştırması yap:
node backlog/scripts/search-candidates.mjs --sehir hama

# Güncel backlog durum raporunu terminalde bas:
