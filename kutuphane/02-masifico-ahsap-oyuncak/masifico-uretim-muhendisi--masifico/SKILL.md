...
4. **Lazer SVG/DXF** — gerçek mm birimli (`width="…mm"` + eş viewBox); kontur çizgileri hairline ≤0,025 mm; parça konturu %50 gri referans katmanında.
   - **Renk kodu — atölyeye SOR, varsayma.** TR fason lazercilerinde yayımlı yaygın kural: **kırmızı RGB 255,0,0 = kesim · mavi RGB 0,0,255 = gravür · siyah = ölçü çizgisi (işlenmez)** (lazerkesimci.com/kurallar, 2026). Bazı atölyeler siyahı gravür sayar — ters kabul, gravürü hiç işlememe veya ölçü çizgilerini kazıma sonucu verir. **Dosyayı göndermeden önce tek cümlelik teyit al:** "Kesim kırmızı, gravür mavi, siyah ölçü — sizde de böyle mi?"
   - Atölye teslim kuralları (aynı kaynak): yalnız `.DXF/.DWG`, birim mm, max tabla **1300×900 mm**, min delik **Ø2 mm**, min köprü **1 mm**, kapalı kontur, metin eğriye çevrilmiş, çakışan çizgi yok, her işlem ayrı katman.
   - **CO₂ lazer masif kayında 6 mm üstünü kesmez** (karbonlaşma). DT-10/KB-24 gibi masif setlerde lazeri **kesim için değil, marka damgası/parti no gravürü için** planla; kesim CNC router'a gider.
...
Çizim aşamasında otomatik uygulanır: 0-3 hedefli üründe hiçbir bağımsız parça <42 mm çizilmez (pratik güvenli bant ≥45 mm); **hareketli eleman** boşlukları 5-12 mm bandına düşmez (Ø5 çubuk giriyorsa Ø12 de girmeli — ezme tuzağı); **rijit malzemedeki delik** ancak ÜÇ şart birden oluşursa uygunsuzdur: Ø5 girer VE derinlik ≥10 mm VE Ø12 girmez (EN 71-8/-14, <36 ay); çıkıntı tabanları 90 N çekme hedefiyle (taban genişliği ≥ gövde çapının %60'ı); pimli birleşimler "tutkallı, sökülemez" notuyla. Her paketin sonunda tek satır: `EN 71 ön kontrol: geçti / şu maddeler lab teyidi ister: …`
...
- [ ] Lazer SVG/DXF mm birimli mi, hairline mı, **renk kodu atölyeyle teyit edildi mi** (kesim kırmızı / gravür mavi / siyah ölçü)?
- [ ] Kereste şartnamesi tam mı: **buharsız · budaksız-ARDAKSIZ, renk uyumlu · nem %8-12 teslim anında · NET ölçü mü kaba ölçü mü**? (Ölçü esası yazılmazsa fiyat %15-17 yanlış okunur; kayında ardak budaktan belirleyicidir.)
- [ ] Parça kalınlıkları TR'de satılan kayın kesitleriyle uyumlu mu (**50/60/80/100 mm'den başlar**) — değilse dilme kalemi teklife eklendi mi?
