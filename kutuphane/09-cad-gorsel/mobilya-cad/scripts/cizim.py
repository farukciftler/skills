...
# Yerleşim veri tipleri CAD bağımsızdır (geometri.py); buradan da
# erişilebilir kalsın: `from cizim import Yerlestirme, Boru`.
from geometri import Boru, Yerlestirme  # noqa: F401
